...
<html>
  <head>
    ...
    <title>My JSP 'ChangeCity.jsp' starting page</title>
  ...
  <body>
  	 ...
  	 <div id="iyoutingche-topleft"><a href="userFindByEmail?email=<%=email %>">欢迎您,${email }</a></div>
  	 <%} else{%>
  	 	 <div id="iyoutingche-topleft"><a>未登录</a></div>
  	 <%} %>
  ...
  <div class="container">
			<div id="iyoutingche-middle">
				...
				<form class="form-inline" onclick="return get_formValues(this)">
					<div class="form-group">
